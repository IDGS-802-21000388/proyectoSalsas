...
class AssignacionPersonal : AppCompatActivity(){
        ...
        call.enqueue(object : Callback<List<Usuario>> {
            override fun onResponse(call: Call<List<Usuario>>, response: Response<List<Usuario>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@AssignacionPersonal, "Error al obtener usuarios", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<List<Usuario>>, t: Throwable) {
                Toast.makeText(this@AssignacionPersonal, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
        ...
        call.enqueue(object : Callback<List<SolicitudProduccion>> {
            override fun onResponse(call: Call<List<SolicitudProduccion>>, response: Response<List<SolicitudProduccion>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@AssignacionPersonal, "Error al obtener datos", Toast.LENGTH_LONG).show()
                }
            }

            override fun onFailure(call: Call<List<SolicitudProduccion>>, t: Throwable) {
                Toast.makeText(this@AssignacionPersonal, "Error: ${t.message}", Toast.LENGTH_LONG).show()
            }
        })
    }
        ...
        call.enqueue(object : Callback<List<DetalleSolicitud>> {
            override fun onResponse(call: Call<List<DetalleSolicitud>>, response: Response<List<DetalleSolicitud>>) {
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@AssignacionPersonal, "Error al verificar detalles de solicitud", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private fun postDetalleSolicitud(detalleSolicitud: DetalleSolicitud) {
        ...
        call.enqueue(object : Callback<ResponseBody> {
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if (response.isSuccessful) {
                    Toast.makeText(this@AssignacionPersonal, "Detalle de solicitud registrado con éxito", Toast.LENGTH_LONG).show()
                } else {
                    Toast.makeText(this@AssignacionPersonal, "Error al registrar detalle de solicitud", Toast.LENGTH_LONG).show()
                }
            }
    ...
    private fun updateDetalleSolicitudUsuario(idDetalleSolicitud: Int, idUsuario: Int) {
        ...
        call.enqueue(object : Callback<Void> {
            override fun onResponse(call: Call<Void>, response: Response<Void>) {
                if (response.isSuccessful) {
                    Toast.makeText(this@AssignacionPersonal, "Usuario asignado correctamente", Toast.LENGTH_LONG).show()
                } else {
                    Toast.makeText(this@AssignacionPersonal, "Error al actualizar usuario", Toast.LENGTH_LONG).show()
                }
            }
